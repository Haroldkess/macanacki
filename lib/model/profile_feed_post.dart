...
class ProfileFeedModel {
    ...
    factory ProfileFeedModel.fromJson(Map<String, dynamic> json) => ProfileFeedModel(
        ...
        data: json["data"] == null ? [] : List<ProfileFeedDatum>.from(json["data"]!.map((x) => ProfileFeedDatum.fromJson(x))),
    );
...
class ProfileFeedDatum {
    ...
    factory ProfileFeedDatum.fromJson(Map<String, dynamic> json) => ProfileFeedDatum(
        id: json["id"],
