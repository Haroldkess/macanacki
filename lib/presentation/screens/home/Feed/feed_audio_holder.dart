...
class FeedAudioHolder extends StatefulWidget {
  String file;
  String vod;
...
class _FeedAudioHolderState extends State<FeedAudioHolder>
  ...
  PageController pageController2 =
      PageController(initialPage: 0, keepPage: false);
  List<FeedPost> nextRandomVideo = VideoWareHome.instance.feedPostsAudio;
  int added = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      }, VideoWareHome.instance.feedPostsAudio),
    );
  }
