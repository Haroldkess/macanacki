...
buyDiamondsModalNG(BuildContext context, rate) async {
  bool pay = true;
...
buyDiamondsModal(BuildContext context, rate) async {
  bool pay = true;
  TextEditingController amount = TextEditingController();

  List<Package> diamondPackages =
      await PayExt.fetchPackagesFromOfferings(identifier: 'diamond');
      ...
      return StatefulBuilder(
        ...
        return FractionallySizedBox(
          ...
          child: Paywall(
            ...
            onSucess: () {
              PaymentController.verifyOnServerDiamondExt(context);
            },
          ),
        );
      });
